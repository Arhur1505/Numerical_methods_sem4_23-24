...
void saveNeededStuffToFile(std::string &fileName, int i, int k, double lambda) {
    std::ofstream file;
...
int main() {
    ...
    std::ofstream ofsMatrix;
    ofsMatrix.open(fileNameMatrix, std::ofstream::out | std::ofstream::trunc);
    ...
    for(int k = 0; k < n; k++) {
        ...
        for(int i = 0; i < IT_MAX; i++) {
            ...
            saveNeededStuffToFile(fileNameLambdas, i, k, lambda);
